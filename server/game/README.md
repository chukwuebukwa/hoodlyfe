...
- `vehicle-simulation-controller.ts` for authoritative engine motion and contacts, occupant projection, mechanical damage, fire, destruction, restoration, and mission return-to-traffic.
