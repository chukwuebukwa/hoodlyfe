...
- **Playable** pistol, SMG, shotgun, rocket launcher, and grenade with distinct cooldown, ammunition, fire mode, projectile, HUD icon, and held-weapon presentation.
...
- **Foundation** weapon-family separation now covers bullet, rocket, thrown, and melee definitions through one shared content catalog; blocking, ground attacks, expanded NPC fight moves, Molotov/fire, mines, throw charging, reloads, recoil/accuracy, durable armor inventory, and weapon shops remain content work.
